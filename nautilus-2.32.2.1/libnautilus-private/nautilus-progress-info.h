...
gboolean      nautilus_progress_info_set_waitPipe    (NautilusProgressInfo *info);
int*          nautilus_progress_info_get_waitPipe    (NautilusProgressInfo *info);
gboolean      nautilus_progress_info_set_job         (NautilusProgressInfo *info,
						      GIOSchedulerJob *job);
void          print                                  (char *str);
